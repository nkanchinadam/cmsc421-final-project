...
train_path = "./SinglePathAndClassTrain.csv"
val_path = "./SinglePathAndClassVal.csv"
...
def train(model, trainloader, optimizer, criterion, device):
    ...
    for i, data in tqdm(enumerate(trainloader), total=len(trainloader)):
        ...
        for i in range(len(outputs.data)):
            ...
            pred[output.index(max(output))] = 1.0
...
torch.save(model.state_dict(), "./ResNetModelSingle.pt")
